...
function TermsAndConditions(props) {
  ...
  return (
    <Container className={classes.container} component="main" maxWidth="md">
      ...
      <p>Welcome to luckerdogs!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of luckerdogs's Website, located at luckerdogs.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use luckerdogs if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing luckerdogs, you agreed to use
        cookies in agreement with the luckerdogs's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, luckerdogs and/or its licensors own the
        intellectual property rights for all material on luckerdogs. All
        intellectual property rights are reserved. You may access this from
        luckerdogs for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from luckerdogs</li>
        <li>Sell, rent or sub-license material from luckerdogs</li>
        <li>Reproduce, duplicate or copy material from luckerdogs</li>
        <li>Redistribute content from luckerdogs</li>
      </ul>
      ...
      <p>
        ...
        luckerdogs does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of luckerdogs,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, luckerdogs shall not be
      ...
      <p>
        luckerdogs reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant luckerdogs a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of luckerdogs; and (d) the link is
      ...
      <p>
        ...
        e-mail to luckerdogs. Please include your name, your organization name,
      ...
      <p>
        No use of luckerdogs's logo or other artwork will be allowed for linking
