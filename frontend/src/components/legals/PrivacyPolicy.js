...
function PrivacyPolicy(props) {
  ...
  return (
    <Container className={classes.container} component="main" maxWidth="md">
      <h1>Privacy Policy of luckerdogs</h1>

      <p>
        luckerdogs operates the luckerdogs.com website, which provides the
        SERVICE.
      </p>
      ...
      <p>
        ...
        decided to use our Service, the luckerdogs website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at luckerdogs.com, unless
